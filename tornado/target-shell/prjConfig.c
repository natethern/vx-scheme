...
/*
GENERATED: Sun Dec 15 00:17:51 Pacific Daylight Time 2002
...
void usrIosExtraInit (void)
    ...
    usrNtPassFsInit ();                 /* direct access to host filesystem */
    }
